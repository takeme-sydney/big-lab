...
[HTML版を開く](../website-pages/microneedle-small-data-ml-review.html)
...
| No. | 文献 | 種別 | 取得状況 | ローカル |
| --- | --- | --- | --- | --- |
| 1 | Yuan et al., 2023 [1] | 原著研究 | 全文・publisher PDF・CC BY | [PDFを開く](../references/papers/2026-07-17-yunong-yuan-email/01-yuan-2023-drug-permeation-microneedled-skin-ml.pdf) |
| 2 | Zheng et al., 2024 [2] | MN総説 | 全文・publisher PDF | [PDFを開く](../references/papers/2026-07-17-yunong-yuan-email/02-zheng-2024-microneedle-biomedical-devices.pdf) |
| 3 | Xu et al., 2023 [3] | materials small-data総説 | 全文・publisher PDF・CC BY 4.0 | [PDFを開く](../references/papers/2026-07-17-yunong-yuan-email/03-xu-2023-small-data-ml-materials-science.pdf) |
| 4 | Dou et al., 2023 [4] | molecular small-data総説 | 全文・HHS author manuscript | [PDFを開く](../references/papers/2026-07-17-yunong-yuan-email/04-dou-2023-ml-methods-small-data-molecular-science.pdf) |
| 5 | Achar & Keith, 2024 [5] | 3頁のHighlight | **全文未取得**。ACSは抄録なし・購読対象 | [取得記録](../references/papers/2026-07-17-yunong-yuan-email/05-achar-keith-2024-highlight-metadata-only.md) |

ファイルサイズ、頁数、入手元、権利メモ、SHA-256は [PDF索引](../references/papers/README.md) に記録した。
...
[提案] 大学購読で取得できた場合は、[取得記録](../references/papers/2026-07-17-yunong-yuan-email/05-achar-keith-2024-highlight-metadata-only.md)の`未確認`欄を更新し、現在のsummaryへ追補する。

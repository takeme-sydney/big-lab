...
- Figure 1(`../research/figures/fig_active_learning_curves.png`)は分布内学習曲線と目標精度到達に必要な実験数、Figure 2(`../research/figures/fig_lodo_comparison.png`)はleave-one-drug-out設定でのRMSE比較を示す。
